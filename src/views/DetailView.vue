<template>
  <div class="detail-view">
    ...
    <section
      class="app-hero"
      ref="appHero"
      :style="{ backgroundImage: baseUrl + app.cover }"
    >
          ...
          <div class="hero-left">
            <div class="app-preview">
              <div class="carousel">
                ...
                >
                  <img
                    v-for="(image, index) in app.previewImages"
                    :key="index"
                    :src="
                ...
                <div class="carousel-indicators">
                  <button
                    v-for="(_, index) in app.previewImages"
                    :key="index"
                    :class="[
                      'indicator-dot',
    ...
    <section class="app-details">
      <div class="details-container">
        <div class="details-content">
          ...
          <div
            class="app-testimonials"
            v-if="app.testimonials && app.testimonials.length && app.previewUrl"
          >
            <h3 class="testimonials-title">用户评价</h3>
            <div class="testimonials-list">
              <div
                v-for="(testimonial, index) in app.testimonials"
                :key="index"
    ...
    <section class="app-media">
      <div class="media-container">
        ...
        <div class="media-logos">
          <img
            src="/static/placeholder.svg?height=50&width=150"
            alt="TechCrunch"
            class="media-logo"
          />
          <img
...
const nextSlide = () => {
  currentSlide.value =
    (currentSlide.value + 1) % app.value.previewImages.length;
};

const prevSlide = () => {
  currentSlide.value =
    (currentSlide.value - 1 + app.value.previewImages.length) %
    app.value.previewImages.length;
};
